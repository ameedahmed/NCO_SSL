...
class TSPEnv:
    ...
    def load_problems(self, episode, batch_size, epoch= 0, curriculum_params=None,schedule_type='linear'):
        ...
        if schedule_type == 'sigmoid':
            ...
            problem_size = min_problem_size + (epoch * size_increase_epochs)
            print(f'Problem size in Linear Loading is {problem_size}')
            
            
        print(f'Problem Size before extracting problems and sols for training or testing is: {problem_size}')
    ...
    def sampling_subpaths(self, problems, solution, length_fix=False, mode='test', repair=False,max_n=100):
        ...
        if mode == 'test':
            ...
            if length_fix:
                ...
                length_of_subpath = min(length_of_subpath,100)
