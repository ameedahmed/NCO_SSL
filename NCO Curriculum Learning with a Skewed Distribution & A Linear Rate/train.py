...
mode = 'train'
training_data_path = b+"/data/first_100000train_rows.txt"
...
trainer_params = {
    ...
    'logging': {
        ...
        'log_image_params_3': {
            'json_foldername': 'log_image_style',
            'filename': 'style_problemsize.json'
               }
               },
    'model_load': {
...
curriculum_params ={
    'min_problem_size':19, #starting the TSP instances of 20 cities
    ...
    'schedule_end_epoch': 100  # end of schedule before the last epoch (only applies to sigmoid)
}
