...
curriculum_params ={
    'min_problem_size':8, #starting the TSP instances of 20 cities
    'max_problem_size': 100, #ending the TSP instances with 100 cities
    'size_increase_epochs': 10, #increasing the problem size every 10 epochs
    'schedule_type': 'sigmoid',  # can be 'linear', 'sigmoid'
    'schedule_end_epoch': 92  # end of schedule before the last epoch (only applies to linear/sigmoid)
}
