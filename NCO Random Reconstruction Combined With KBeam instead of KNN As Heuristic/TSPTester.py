##Implemented Auto Mixed Precision Package HAS BEEN REMOVED
        ...
        with torch.no_grad():
            ...
            while not done:
                if current_step == 0:
                    ...
                    selected_teacher, _,_,selected_student, _, _ = self.model(
                    state,self.env.selected_node_list,self.env.solution,current_step,1)
