...
mode = 'test'
training_data_path = b+"/data/output_knn_tsp.txt" 
...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': '/home/ahmed003/NCO_code_Kbeam/single_objective/LEHD/TSP/result/Saved_Model_For_TSP_KNN',  # directory path of pre-trained model and log files saved.
...
def _set_debug_mode():
    ...
    trainer_params['train_episodes'] = (356)
