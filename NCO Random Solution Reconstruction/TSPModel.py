...
class TSPModel(nn.Module):
    ...
    def forward(self, state, selected_node_list, solution, current_step,repair = False,mode='test'):
        ...
        if self.mode == 'test':
            ...
            if  repair == True :
                ...
                selected_student = probs.argmax(dim=1) #--> Beam search to be integrated here
                selected_teacher = selected_student
                prob = 1
